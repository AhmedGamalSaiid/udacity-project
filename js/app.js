...
const navBrElement = document.querySelector('#navbar__list');
...
const getSectionPositin = (section) => {
    return section?.getBoundingClientRect();
}

const isSectionInViwPort = (section) => {
    const currentSectionPosition = getSectionPositin(section);
...
const addHomeItem = () => {
    ...
    navBrElement.appendChild(homeItem);
}
...
const navBarItemsBuilder = () => {
    ...
    navBrElement.appendChild(tempDoc);
}
...
const scrollToSection = () => {
    document.querySelectorAll('a').forEach(anchor => {
        anchor.addEventListener('click', function (e) {
            ...
            const topPosition = getSectionPositin(section)?.top + window.pageYOffset
